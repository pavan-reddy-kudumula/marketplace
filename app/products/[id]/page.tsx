...
export default async function ProductDetailPage({
  ...
  const reviewEligibility = await canReviewProduct(id);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-100 px-4 py-10">
      <div className="mx-auto max-w-6xl">
        <Link
          href="/products"
          className="mb-6 inline-block text-sm font-medium text-indigo-700 hover:underline"
        >
          ← Back to products
        </Link>
        ...
        {reviewEligibility.success && <div className="mt-8 rounded-2xl bg-white p-6 shadow-md md:p-8">
          ...
          <RatingForm
            productId={id}
            productName={product.name}
            canReview={reviewEligibility.success}
          />
        </div> }
